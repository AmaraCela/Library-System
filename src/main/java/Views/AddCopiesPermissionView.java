...
public class AddCopiesPermissionView extends BorderPane {
    ...
    public AddCopiesPermissionView(Stage stage)
    {
        this.stage = stage;
        ...
        {
            if(((Manager)RegisterStaffController.getManagers().get(i)).isAddToStock())
            {
        ...
        Text revokeAddCopies = new Text("Revoke the permission of adding copies: ");
        Text allowAddCopies = new Text("Allow the permission of adding copies: ");

        revokeAddCopies.setFont(Font.font("Arial Rounded MT Bold",12));
        allowAddCopies.setFont(Font.font("Arial Rounded MT Bold",12));

        revokeAddCopies.setFill(Color.DARKBLUE);
        allowAddCopies.setFill(Color.DARKBLUE);

        GridPane gridPane = new GridPane();
        gridPane.add(revokeAddCopies,0,0);
        gridPane.add(allowAddCopies,1,0);
